...
run_name <- args[2] # Tom please change the args[??] to reflect command_line inputs
scenario_name <- args[3] # Tom please change the args[??] to reflect command_line inputs
gcam_dir <- args[4]
