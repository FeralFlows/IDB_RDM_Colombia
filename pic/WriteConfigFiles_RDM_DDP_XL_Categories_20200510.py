...
base_dir = 'E:/NEXO-UA/Results/RDM_Colombia/scenario_generator/' # '/Users/mengqi/Google Drive/Research/Others/Python/scenario_generator/'
base_pic_dir = '../input/'
...
for gcam_scen in scenarios:
    ...
    impacts_ag_water = {}
    xml_dir = base_pic_dir + 'idb_5.3/rdm/XL_category_files/'
    for key in XL_fac:
        print(key)
            ...
            for item in XL_fac[key]:
                ...
                if key_item in XL_cat:
                    ...
                    for cat in XL_cat[key_item]:
                        append_str += str(xml_dir + key_item + '_' + cat + '.xml;')
